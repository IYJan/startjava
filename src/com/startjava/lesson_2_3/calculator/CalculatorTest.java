...
public class CalculatorTest {
	...
	public static void startGame() {
		do {
			...
			String[] lineText = text.split("[\\Q^*/+-%\\E]"); //занести в массив (каждый набор символов в отдельные €чейки)строк символы сто€щие перед указанными символами в [] и после них
			sign = checkSign(text);
	...
	private static char checkSign(String text) {
		if (text.indexOf("^") != -1) {
			...
			System.out.println("јрифметические операции только со знаками: ^, /, *, +, -, %");
